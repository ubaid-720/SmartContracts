...
contract CryptoKingdom is ERC721, Ownable,Pausable {
    ...
    uint256 private currentPrice = 0.06 ether;
    uint256 private maxQuantity=20;
    ...
    constructor(string memory _baseURII) ERC721("CRYPTO KINGDOM", "KINGDOM"){tokenBaseURI=_baseURII; Owner = payable(msg.sender);}
